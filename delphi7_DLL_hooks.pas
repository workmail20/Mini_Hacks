...
function HookProc(Proc: pointer; NewProc: pointer; var OldProc: pointer): boolean;
...
begin
  ...
  until ((pModule <> nil) or (Offset > $50000000));
  if pModule = nil then Exit;
...
begin
  ...
  if hModule <> 0 then begin
    ...
    if Proc <> nil then begin
      ...
      OldFunction := VirtualAlloc(nil, 255, MEM_RESERVE or MEM_COMMIT, PAGE_EXECUTE_READWRITE);
       // GetMem(OldFunction, 255);
      if OldFunction <> nil then begin
